  ...
  return (
    <div className='w-full  py-40 px-4' id='career'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 items-center'>
        ...
        <img className='w-48 md:w-[300px] lg:w-[400px] mx-auto my-4' src={'https://www.dice.com/binaries/medium/content/gallery/dice/insights/2019/06/shutterstock_714589963.jpg'} alt='Ratan Tata' />
